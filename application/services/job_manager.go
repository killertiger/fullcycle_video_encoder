...
func NewJobManager(db *gorm.DB, messageChannel chan amqp.Delivery, jobReturnChannel chan JobWorkerResult, rabbitMQ *queue.RabbitMQ) *JobManager {
	return &JobManager{
		Db:               db,
		Domain:           domain.Job{},
